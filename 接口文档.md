...
```json
{
  ...
  "data": {
    "shippingInfo": {
      ...
      "trackingNumber": "SF0012345678",
      "senderAddress": "广州市天河区某仓库",
      "senderLongitude": 113.94604,
      "senderLatitude": 22.54461,
      "receiverAddress": "深圳市南山区科技园",
      "receiverLongitude": 113.95404,
      "receiverLatitude": 22.54461,
      "estimatedDelivery": "2025-06-02T15:00:00"
    },
    "senderLocation": {
      "longitude": 113.94604,
      "latitude": 22.54461,
    ...
    "pathPoints": [
      {
        "longitude": 113.94604,
        "latitude": 22.54461,
        "time": "2025-05-28T06:02:34",
        "status": "已从仓库发出"
      },
      {
        "longitude": 113.94904,
        "latitude": 22.54761,
        "time": "2025-05-29T10:15:20",
        "status": "运输中"
      },
      {
        "longitude": 113.95204,
        "latitude": 22.55061,
        "time": "2025-05-30T16:45:12",
        "status": "即将送达"
      },
      {
        "longitude": 113.95404,
        "latitude": 22.54461,
        "time": "2025-05-31T09:30:00",
        "status": "已送达"
      }
    ]
  }
...
**说明**:
- 此接口返回完整的物流路线信息，包括物流基本信息、发送方和接收方位置、路线信息和路径点
- 前端可以使用这些数据自行渲染物流路线地图和物流跟踪时间线
- 使用前后端分离模式，前端负责UI渲染，后端只提供数据


**说明**:
- 此接口返回订单的最新物流状态信息，用于在订单列表或详情中显示
- 不包含完整的路线信息，只返回最新的状态数据
